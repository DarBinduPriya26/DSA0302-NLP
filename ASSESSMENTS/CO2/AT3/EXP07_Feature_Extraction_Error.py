...
X_train_after = vectorizer_after.fit_transform(
    train_stemmed
)

X_test_after = vectorizer_after.transform(
    test_stemmed
)
...
print(
    "Accuracy Before Stemming:",
    round(
        accuracy_score(test_labels, pred_before) * 100,
        2
    ),
    "%"
)
...
print(
    "Accuracy After Stemming:",
    round(
        accuracy_score(test_labels, pred_after) * 100,
        2
    ),
    "%"
)
